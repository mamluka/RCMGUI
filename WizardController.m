...
for i=1:vector1Length
    ...
    for j=1:vector2Length
        ...
        elseif viewModel.ModelType == ModelType.ExtendedCallwayModel
            Kappa(i,j) = CallawayExtendedLatticeHeatCond(c,tm,T);
        else
